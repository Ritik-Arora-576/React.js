...
<ul>
  ...
  <li>In JSX instead of writing <em>'class'</em> we use <em>'className'</em>. Tags which are not having closing tags eg.<em><img src='img.png'></em> gets closed in JSX by using <em><img src='img.png'/></em>.</li>
